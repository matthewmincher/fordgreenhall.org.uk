...
import {useEffect, useState, useMemo, PropsWithChildren, FC, ReactNode} from "react";
...
const CalendarEvent: FC<Props> = ({
    ...
    const hideFrom = useMemo(() => end ? new Date(end.getTime() + 43200000) : null, [end]);
    const [isVisible, setIsVisible] = useState(!hideFrom || hideFrom >= new Date());
