...
const InsidePage = () => {
  const [lightboxImage, setLightboxImage] = useState<ImageDefinition | null>(
    null,
  );
      ...
      <div className={`constrainedContent ${Styles.container}`}>
        <div className={Styles.padded}>
          ...
          <p className={Styles.copy}>
            <strong>The Hall</strong> was the most important room of the house.
            Originally much of the cooking would have been carried out over the
            hearth in this room, and the family would also have eaten their
            meals here.
          </p>
          <p className={Styles.copy}>
            <strong>The Parlour</strong> was originally used as both principal
            bedroom and sitting-room. This arrangement was quite common in
            houses of the 16th and 17th centuries, when the parlour contained
            the best and most expensive items of furniture, including the best
            bed.
          </p>
          <p className={Styles.copy}>
          ...
          <p className={Styles.copy}>
            ...
            when it was fashionable to add an imposing entrance to your house.
            It also gave added privacy and prevented draughts.
          </p>
        </div>
          ...
          <div className={`styledScrolling ${Styles.planScroller}`}>
            <div style={{ position: 'relative' }}>
              ...
              <div
                ...
                style={{ top: '270px', left: '395px' }}
                onClick={() => onThumbnailClicked('parlour')}
                onKeyPress={(e) => {
              ...
              <div
                className={Styles.thumb}
                style={{ top: '204px', left: '670px' }}
                onClick={() => onThumbnailClicked('hall')}
                onKeyPress={(e) => {
              ...
              <div
                className={Styles.thumb}
                style={{ top: '186px', left: '926px' }}
                onClick={() => onThumbnailClicked('kitchen')}
                onKeyPress={(e) => {
              ...
              <div
                className={Styles.thumb}
                style={{ top: '345px', left: '926px' }}
                onClick={() => onThumbnailClicked('exhibition')}
                onKeyPress={(e) => {
        ...
        <div className={Styles.padded}>
          ...
          <p className={Styles.copy}>
            ...
            spinning and embroidery but in 1712 it was a bedroom containing 3
            beds. A section of the wall has been cut away to show the original
            wattle and daub which was used as filling between the timbers.
          </p>
          <p className={Styles.copy}>
            <strong>The Buttery Chamber</strong> is so called because of its
            position above what was once the buttery. Originally used as a
            bedroom, the simple bedstead is a copy of the type of beds which
            most of the household at Ford Green would have slept in.
          </p>
          <p className={Styles.copy}>
            <strong>The Porch Chamber</strong> is now displayed as a study, but
            was also used at different periods as a dressing-room, and for
            storage.
          </p>
        </div>
          ...
          <div className={`styledScrolling ${Styles.planScroller}`}>
            <div style={{ position: 'relative' }}>
              ...
              <div
                ...
                onClick={() => onThumbnailClicked('buttery')}
                onKeyPress={(e) => {
              ...
              <div
                className={Styles.thumb}
                style={{ top: '238px', left: '145px' }}
                onClick={() => onThumbnailClicked('parlour_chamber')}
                onKeyPress={(e) => {
              ...
              <div
                className={Styles.thumb}
                style={{ top: '158px', left: '433px' }}
                onClick={() => onThumbnailClicked('hall_chamber')}
                onKeyPress={(e) => {
