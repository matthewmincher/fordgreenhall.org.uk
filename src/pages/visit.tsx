                ...
                <div className={Styles.visitContainer}>
                    ...
                    <div className={Styles.openingDetails}>
                        ...
                        <div className={Styles.openingDetailsRight}>
                            ...
                            <p>Ramp access is situated at the front of the Hall, accessed from the main road. More
                                information can be found on our <Link
                                    to='/visit/access'><span>access information page</span> <FontAwesomeIcon
                                    icon={faLink}/></Link></p>
                        </div>
                    </div>
