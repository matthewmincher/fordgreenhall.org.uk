        ...
        <div className={Styles.container}>
          ...
          <div className={Styles.padded}>
            ...
            <ul className={Styles.linksList}>
              <li>
                <a
                  href="https://www.stokemuseums.org.uk"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.visitstoke.co.uk/"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.tripadvisor.co.uk/Tourism-g186378-Stoke_on_Trent_Staffordshire_England-Vacations.html"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FontAwesomeIcon icon={faLink} />{' '}
                  <span>Stoke-on-Trent Trip Advisor</span>
                </a>
              </li>
              <li>
                <a
                  href="https://en.wikipedia.org/wiki/Ford_Green_Hall"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FontAwesomeIcon icon={faLink} />{' '}
                  <span>Ford Green Hall - Wikipedia</span>
                </a>
              </li>
              <li>
                <a
                  href="https://www.culture24.org.uk/wm000061"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FontAwesomeIcon icon={faLink} />{' '}
                  <span>Ford Green Hall - Culture24</span>
                </a>
              </li>
              <li>
                <a
                  href="https://www.smallthorne-history.org.uk/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FontAwesomeIcon icon={faLink} />{' '}
                  <span>Smallthorne History</span>
                </a>
              </li>
            </ul>
            ...
            <ul className={Styles.linksList}>
              <li>
                <a href={'/pdfs/Wedding Pack 2019.pdf'}>
                  <FontAwesomeIcon icon={faFilePdf} /> <span>Wedding Pack</span>
                </a>
              </li>
              <li>
                <a href={'/pdfs/History of Smallthorne and Ford Green.pdf'}>
                  <FontAwesomeIcon icon={faFilePdf} />{' '}
                  <span>History of Smallthorne and Ford Green</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className={Styles.thirdparties}>
            <div>
              <a
                href="https://www.visitenglandassessmentservices.com/establishments/ford-green-hall/"
                target="_blank"
                rel="noreferrer"
              >
                <StaticImage
            ...
            <div>
              <a
                href="https://www.tripadvisor.co.uk/Attraction_Review-g186378-d1647083-Reviews-Ford_Green_Hall-Stoke_on_Trent_Staffordshire_England.html"
                target="_blank"
                rel="noreferrer"
              >
                <StaticImage
            ...
            <div>
              <a
                href="https://www.pegasusfireandsecurity.com/"
                target="_blank"
                rel="noreferrer"
              >
                <StaticImage
